...
namespace UniqueTodoApplication.Implementation.Service
{
    public class CustomerService : ICustomerService
    {
        ...
        public CustomerService(ICustomerRepository customerRepository, IUserRepository userRepository, IRoleRepository roleRepository, IMailService mailService)
        {
        ...
        {
            var customer = await _customerRepository.ExistsByEmail(model.Email);
            if (customer == true)
            {
                return new BaseResponse<CustomerDto>
                {
            ...
            return new BaseResponse<CustomerDto>
            {
                ...
                Data = new CustomerDto
                {
                    ...
                    MaritalStatus = customerss.MaritalStatus,
                    CustomerPhoto = customerss.CustomerPhoto,
                    CreatedBy = $"{customerss.FirstName} {customerss.LastName}"
                }
            };
